...
namespace project_donerci_otomasyonu
{
    public partial class Form1 : Form
    {
        public static String DbName = "DonerciOtomasyonu";

        public SqlConnection GetEmptyCon()
        {
            SqlConnection con = new SqlConnection($"Server=10.0.2.15,1433; User Id=sa;Password={Environment.GetEnvironmentVariable("MSSQL_PASSWORD")};TrustServerCertificate=True;");
            //new SqlConnection($"server=localhost; user id=sa; password={Environment.GetEnvironmentVariable("MSSQL_PASSWORD")}");
            return con;
        ...
        {
            SqlConnection con = new SqlConnection($"Server=10.0.2.15,1433;Database={DbName};User Id=sa;Password={Environment.GetEnvironmentVariable("MSSQL_PASSWORD")};TrustServerCertificate=True;");
            //new SqlConnection($"server=localhost; database={DbName}; user id=sa; password={Environment.GetEnvironmentVariable("MSSQL_PASSWORD")}");
            return con;
        }
        public Form1()
        {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand command = new SqlCommand($"If(db_id(N'DonerciOtomasyonu') IS NULL) CREATE DATABASE [{DbName}]", connection);
                connection.Open();
